package com.infy.ekart.notification.utility;
...
import com.infy.ekart.notification.exception.EkartNotificationException;
...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(EkartNotificationException.class)
	public ResponseEntity<ErrorInfo> ekartExceptionHandler(EkartNotificationException exception) {
		ErrorInfo error = new ErrorInfo();
