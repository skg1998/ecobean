...
import { CustomerCartDTO } from '../../core/interfaces/Cart';
...
export class SetCart implements Action {
  ...
  constructor(public payload: { cart: CustomerCartDTO; effect: string }) {}
}

export class RemoveFromCart implements Action {
  readonly type = REMOVE_FROM_CART;
  constructor(public payload: number) {} // index of the product in the list to be deleted
}
